...
var getSDK_1 = __webpack_require__(/*! ./getSDK */ 616);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../webpack/buildin/global.js */ 21), __webpack_require__(/*! ./../process/browser.js */ 201)))
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../webpack/buildin/global.js */ 21), __webpack_require__(/*! ./../../../timers-browserify/main.js */ 614).setImmediate))
...
var _browser = __webpack_require__(/*! ./browser */ 237);

var _env = __webpack_require__(/*! ./env */ 118);
...
var assert = __webpack_require__(/*! ./assert */ 344);
var BiLogger = __webpack_require__(/*! ./bi-logger */ 345);
...
var _require = __webpack_require__(/*! ./utils/collections */ 629),
    mapValues = _require.mapValues;

var promise = __webpack_require__(/*! ./utils/promise */ 630);

var _require2 = __webpack_require__(/*! ./utils/log */ 631),
    log = _require2.log;
...
exports.default = __webpack_require__.stylable.create(
  ...
  "",
  7,
  /*! ./components/VideoPlayer/VideoPlayer.st.css */ 346
);
...
exports.default.$skin.$render = function render_css($id, $params, $functions) {
  return "\n" + $id + ".Video2864290985--root{position: relative}\n" + $id + " .Video2864290985--playerContainer{position: relative;height: 100%;width: 100%;background-color: #000}\n" + $id + " .Video2864290985--playerContainer iframe{height: 100%;width: 100%;visibility: visible}\n" + $id + " .Video2864290985--cover{position: absolute;top: 0;left: 0;height: 100%;width: 100%;background: #000 50% 50% no-repeat;background-size: cover;cursor: pointer}\n" + $id + " .Video2864290985--overlay{display: flex;height: 100%;justify-content: center;flex-direction: column;align-items: center;background-color: rgba(0,0,0,0.35)}\n" + $id + " .Video2864290985--title{margin: 0 15px 15px;text-align: center}\n" + $id + ".VideoPlayer4111471387--root{box-shadow: " + $params["boxShadow"] + ";border: " + $params["borderSize"] + " solid " + $params["borderColor"] + ";margin-top: calc(-1 * " + $params["borderSize"] + ");margin-left: calc(-1 * " + $params["borderSize"] + ")}\n" + $id + ".VideoPlayer4111471387--root .Video2864290985--title{font: " + $params["font"] + ";color: " + $params["fontColor"] + ";margin: 0 0 15px;padding: 0 .2em;display: -webkit-box;-webkit-line-clamp: 2;-webkit-box-orient: vertical;overflow: hidden;max-height: 2.8em}\n" + $id + ".VideoPlayer4111471387--root[data-videoplayer4111471387-ismobileview] .Video2864290985--title{font-size: calc(18 * " + $params["textSizeScale"] + ");margin: 0 0 10px}\n" + $id + ".VideoPlayer4111471387--root .Video2864290985--overlay{background-color: " + $params["backgroundColor"] + ";padding: 0 10%;transition: opacity .2s ease}\n" + $id + ".VideoPlayer4111471387--root .VideoPlayer4111471387--playButton{display: block;width: " + $params["playButtonSize"] + ";height: " + $params["playButtonSize"] + ";padding: 0;border: 0;background: transparent;box-sizing: border-box;cursor: pointer;transition: opacity .2s ease}\n" + $id + ".VideoPlayer4111471387--root .VideoPlayer4111471387--playButton:hover{opacity: .8}\n" + $id + ".VideoPlayer4111471387--root[data-videoplayer4111471387-ismobileview] .VideoPlayer4111471387--playButton{width: " + $params["playButtonMobileSize"] + ";height: " + $params["playButtonMobileSize"] + "}\n" + $id + " .VideoPlayer4111471387--playButton circle{stroke: " + $params["fontColor"] + "}\n" + $id + " .VideoPlayer4111471387--playButton path{fill: " + $params["fontColor"] + "}\n";
};
...
var _VideoPlayer = __webpack_require__(/*! ./VideoPlayer */ 608);

var _VideoPlayerSt = __webpack_require__(/*! ./VideoPlayer.st.css */ 346);
...
exports.default = __webpack_require__.stylable.create(
  "root",
  "Video2864290985",
  {"root":"Video2864290985--root","playerContainer":"Video2864290985--playerContainer","cover":"Video2864290985--cover","overlay":"Video2864290985--overlay","title":"Video2864290985--title"},
  "",
  1,
...
var _video = __webpack_require__(/*! wix-ui-core/video */ 609);

var _playbackBiModule = __webpack_require__(/*! @wix/playback-bi-module */ 622);

var _events = __webpack_require__(/*! ./bi/events */ 635);

var _videoPlayerBehaviors = __webpack_require__(/*! ./behaviors/videoPlayerBehaviors */ 636);

var _VideoPlayerSt = __webpack_require__(/*! ./VideoPlayer.st.css */ 346);

var _VideoPlayerSt2 = _interopRequireDefault(_VideoPlayerSt);

var _playButtonIcon = __webpack_require__(/*! ./playButtonIcon */ 637);
...
module.exports = __webpack_require__(/*! ./dist/src/components/video */ 610);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Video_1 = __webpack_require__(/*! ./Video */ 611);
...
var React = __webpack_require__(/*! react */ 0);
var players_1 = __webpack_require__(/*! ./players */ 612);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Playable_1 = __webpack_require__(/*! ./Playable */ 613);
var YouTube_1 = __webpack_require__(/*! ./YouTube */ 615);
var Facebook_1 = __webpack_require__(/*! ./Facebook */ 618);
var Vimeo_1 = __webpack_require__(/*! ./Vimeo */ 619);
var Twitch_1 = __webpack_require__(/*! ./Twitch */ 620);
var DailyMotion_1 = __webpack_require__(/*! ./DailyMotion */ 621);
// @TODO enum ?
...
var isArray = __webpack_require__(/*! lodash/isArray */ 236);
var playable_1 = __webpack_require__(/*! playable */ 341);
...
__webpack_require__(/*! setimmediate */ 233);
...
var eventemitter3_1 = __webpack_require__(/*! eventemitter3 */ 42);
var isString = __webpack_require__(/*! lodash/isString */ 91);
var utils_1 = __webpack_require__(/*! ../utils */ 117);
var constants_1 = __webpack_require__(/*! ../constants */ 56);
var playerHOC_1 = __webpack_require__(/*! ./playerHOC */ 92);
var Video_st_css_1 = __webpack_require__(/*! ../Video.st.css */ 57);
...
Object.defineProperty(exports, "__esModule", { value: true });
var originalLoadjs = __webpack_require__(/*! loadjs */ 617);
...
Object.defineProperty(exports, "__esModule", { value: true });
__export(__webpack_require__(/*! ./playback-bi-module */ 623));
//# sourceMappingURL=index.js.map
...
Object.defineProperty(exports, "__esModule", { value: true });
var playable_1 = __webpack_require__(/*! playable */ 341);
var web_bi_logger_1 = __importDefault(__webpack_require__(/*! @wix/web-bi-logger */ 624));
var bi_logger_video_platform_1 = __importDefault(__webpack_require__(/*! @wix/bi-logger-video-platform */ 634));
...
var _tracker = __webpack_require__(/*! ./lib/tracker */ 625);

var tracker = _interopRequireWildcard(_tracker);

var _logger = __webpack_require__(/*! ./logger */ 627);
...
var _navigator = __webpack_require__(/*! ./navigator */ 626);
...
var _wixBiLoggerClient = __webpack_require__(/*! @wix/wix-bi-logger-client */ 628);

var _env = __webpack_require__(/*! ./lib/env */ 118);

var env = _interopRequireWildcard(_env);

var _publishers = __webpack_require__(/*! ./lib/publishers */ 632);
...
var BiLoggerClientFactory = __webpack_require__(/*! ./bi-logger-factory */ 343);
var BiLogger = __webpack_require__(/*! ./bi-logger */ 345);
...
var _transport = __webpack_require__(/*! ./transport */ 633);
...
/* tslint:disable */
/* eslint:disable */
var BiLoggerFactory = __webpack_require__(/*! @wix/wix-bi-logger-client/dist/bi-logger-factory */ 343);
/**
* @typedef {string} Url
*/
/**
...
var tslib_1 = __webpack_require__(/*! tslib */ 6);
var React = __webpack_require__(/*! react */ 0);
var uniqueId = __webpack_require__(/*! lodash/uniqueId */ 60);
var constants_1 = __webpack_require__(/*! ../constants */ 56);
